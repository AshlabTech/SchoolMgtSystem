...
?>
<h4><a href="payment_details.php" class="btn btn-primary" name="info" style="margin-right:20px;">Back</a> Student Application Form </h4>
		<div id="" style="width:80%;margin:10px auto">
			...
			<div class="row" id="" style="display:block">
				...
				<div class="col-lg-6">
					...
					<div id="std_reg_ouput">
						...
						<button type="button" class="btn btn-primary" onclick="submit_application()">Submit</button>
					  </div>
