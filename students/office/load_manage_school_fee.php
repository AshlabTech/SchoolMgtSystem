					...
					<div class="col-md-12 " style="padding:">
							...
							<div class="form-inline"  style="margin:5px 20px">
								  ...
								  <div class="form-group">
									...
									<select class="form-control" style="display:inline-block" id="current_session">
			...
			<div class="row" style="margin:0;;min-height:400px;">
				...
				<div class="col-md-2" style="border:1px solid #ccc;height:100%;padding-top:20px">
					...
					<div class="list-group">
						  ...
						  <a href="#" class="list-group-item btn btn-default" style="background-color:#f0f0f0;color:red">Logout</a>
						</div>
				</div>					
			</div>			
