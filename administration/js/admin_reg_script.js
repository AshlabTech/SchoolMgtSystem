...
function add_new_staff(){
	// staff  data
	var staff_title = getId('staff_title').value;
	...
	var staff_category = getId('staff_category').value;
			...
			getId('save_staff_output').innerHTML = '<img src="../../images/ajax-loader.gif">';
					...
					$.post('../php/add_new_staff.php',{staff_title:staff_title,first_name:first_name,last_name:last_name,other_name:other_name,gender:gender,religion:religion,
...
getId('add_new_student_feedback').innerHTML = '<div class="alert alert-danger">skkskksk</div>';
	...
	var student_type = getId('student_type').value;
			if(empty(getId('adm_no').value)){
				$('#adm_no').focus();
			}else if(empty(getId('first_name').value)){
				$('#first_name').focus();
			}	else if(empty(getId('last_name').value)){
				$('#last_name').focus();
			}else if(empty(getId('gender').value)){
				...
				getId('add_new_student_feedback').innerHTML = '<img src="../../images/ajax-loader.gif">';
					//post the data to php
					$.post('../php/save_new_student.php',{adm_no:adm_no,first_name:first_name,last_name:last_name,other_name:other_name,gender:gender,religion:religion,
