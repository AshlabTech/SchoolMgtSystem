...
for ($month_id = 1; $month_id <= $months_num_rows; $month_id++) { // this loop will go the number of months we have 1.e 12 times
	...
	$countt = "select COUNT(student_class_id) from student_classes where class_id = '$class_id'   and session_id = '$session_id' and status != '0'";
	...
	$sql_all_class = "select * from student_classes where class_id = '$class_id' and session_id = '$session_id' and status != '0' ORDER BY student_class_id LIMIT $limit";
