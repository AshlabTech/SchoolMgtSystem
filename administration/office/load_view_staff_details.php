									...
									<div class="col-lg-4">
											<div class="myOp" style="margin:10px;box-shadow:1px 1px 1px 1px #ccc;height:350px;border-radius:0px 0px 10px 10px">
												...
												<ul class="nav nav-list ">
															...
															<li class=" option_btn" onmouseup="load_edit_staff_details(<?php echo $staff_info_id; ?>)">
															<a href="#">
																<i class="menu-icon glyphicon glyphicon-cog"></i>
																<span class="menu-text">   Edit Staff Details </span>
															</a>
															<b class="arrow"></b>
															</li>
															<li class=" option_btn" onmouseup="load_change_password(<?php echo $staff_info_id; ?>)">
															<a href="#">
