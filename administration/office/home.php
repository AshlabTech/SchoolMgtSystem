		<div class="row w-100 m-0" >
			<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 p-0 myOp" style="margin:0;padding-right:0;height:85vh; overflow-y:scroll;">
				<div style="margin:0">
			...
			<div class="col-xs-12  col-sm-8 col-md-9 col-lg-10 pb-0" style="height: ;" id="display_content">
		...
		<script type="text/javascript">
			...
			function remove_student_inclass(token, class_id) {
				...
				if (con == true) {
					$.post("load_all_student_inclass.php", {
						student_toremove: token
